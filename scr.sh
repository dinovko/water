...
mkdir /opt/admin/tomcat_geoserver/webapps/geoserver/WEB-INF
mkdir /opt/admin/tomcat_geoserver/webapps/geoserver/WEB-INF/lib
...
mkdir /usr/bin/tomcatUp
mkdir /usr/bin/tomcatDown
mkdir /usr/bin/geoserverUp
mkdir /usr/bin/geoserverDown
